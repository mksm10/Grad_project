...
<tr>
    ...
    <td style="text-align:center;"><span id="total">0</span>
        <input type="hidden" name="total2" id="total2"></td>
</tr>

<!-- "Total" Operations -->

<tr style="text-align:left;">
    <th  colspan="3">Judges name:<input type="text" style="width: 132px; background-color: lightgray;margin-left: 10px;" name="judge_name" value="Judge2">
